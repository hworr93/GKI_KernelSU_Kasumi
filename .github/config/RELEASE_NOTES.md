...
A kernel-based root solution for Android GKI/Linux devices, completely rewritten in C++.
...
An out-of-tree Linux kernel module for Android GKI/Linux path control in root/SU environments.

- Path redirection and spoofing via anonymous fd + ioctl control plane
- Symbol resolution fallbacks and strict CFI compatibility
- Directory entry hiding and maps/cmdline/statfs spoofing
